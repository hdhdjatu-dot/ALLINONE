...
# HSL-ALL-IN-ONE-BOT/cookies.txt
...
def find_ffmpeg():
    ...
    print(
        "[MUSIC] ⚠️ FFmpeg not found in known paths."
    )
    ...
    async def play_next(
        ...
        try:
            ...
            # -------------------------------------------------
                ...
                # Search YouTube for a related result
                autoplay_query = (
                    self.current.title
                )
