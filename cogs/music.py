...
class MusicPlayer:
    ...
    async def autoplay_song(self):
        ...
        categories = [
            ...
            "Atif Aslam popular songs",
            "AP Dhillon popular songs",
            "Shubh popular songs",
            "Karan Aujla popular songs",
            "Badshah popular songs",
            "KK Bollywood songs",
            "2000s Hindi songs",
                ...
                try:
                    ...
                    await loading.edit(
                        content=(
                            ...
                            "this song.** Try another "
                            "song name or use a YouTube URL."
                        )
                    )
