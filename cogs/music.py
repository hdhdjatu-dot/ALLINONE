...
if YOUTUBE_COOKIES:
    ...
    print(
        "[MUSIC] WARNING: YOUTUBE_COOKIES variable not found."
    )
...
def find_ffmpeg():
    ...
    print(
        "[MUSIC] WARNING: FFmpeg not found."
    )
...
class MusicPlayer:
    ...
    async def resolve_song(
        ...
        def extract():
            ...
            if search_query_clean.startswith(
                (
                    "http://",
                    "https://"
                )
